...
`);
  ...
  Hooks2.Chat = {
    ...
    setupEventListeners() {
      ...
      function startTimer(time) {
        ...
        const updateTimer = () => {
          ...
          if (remaining <= 0) {
            ...
            let seconds = Math.floor(remaining / 1e3 % 60);
            let minutes = Math.floor(remaining / (1e3 * 60) % 60);
      ...
      function receiveMessage(msg) {
        $('<div class="message new"><figure class="avatar"><img src="/images/eva.png" /></figure>' + msg + "</div>").appendTo($(".mCSB_container")).addClass("new");
        setDate();
        updateScrollbar();
      }
  ...
  liveSocket = new LiveSocket("/live", Socket, { hooks: Hooks2, params: { _csrf_token: csrfToken } });
  liveSocket.connect();
